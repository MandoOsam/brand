    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          A live snapshot of your store.
        </p>
      </div>

      {!isConfigured && (
        <div className="rounded-2xl border border-gold/30 bg-gold/5 p-4 text-sm text-muted-foreground">
          Connect Supabase to see real numbers here — right now these are all
          zero because the dashboard has nothing to read yet. See README.md.
        </div>
      )}
